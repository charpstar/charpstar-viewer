...
const RenderOptionsPanel: React.FC<RenderOptionsPanelProps> = ({ modelViewerRef, modelFilename }) => {
  const params = useParams();
  const clientName = (params?.client as string) || '';

  const cameraPresets = useMemo(() => ([
    { name: 'default', label: 'Default', orbit: '20deg 80deg 100%' },
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-5 gap-5">
              ...
              <div>
                <label className="text-xs font-semibold text-gray-700 uppercase tracking-wide mb-3 block">Color</label>
                <div>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    disabled={!modelFilename || isSubmitting || isBlocked || isRenderingAll}
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    disabled={!modelFilename || isSubmitting || isBlocked || isRenderingAll}
                    className="flex-1 h-12 text-base font-semibold border-2 border-black hover:bg-gray-100"
                  >
                    {isRenderingAll ? (
                      <>
                        <Loader2 className="w-5 h-5 mr-2 animate-spin" />
                ...
                <TooltipContent>
                  <div className="text-sm">Queue renders for all variants at 1024px</div>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
