...
import { Hotspot, HotspotState, Vector3 } from "@/types/hotspots";
...
export default function Home() {
  ...
  // Hotspot handler functions
  const handleHotspotCreate = (position: Vector3) => {
    ...
    console.log("Created hotspot:", newHotspot);
  };
  ...
  const handleHotspotUpdate = (hotspotId: string, comment: string) => {
    setHotspotState(prev => ({
      ...prev,
  ...
  const handleHotspotDelete = (hotspotId: string) => {
    setHotspotState(prev => ({
      ...
      selectedHotspotId: prev.selectedHotspotId === hotspotId ? null : prev.selectedHotspotId,
    }));
  };

  const handleHotspotToggleVisibility = (hotspotId: string) => {
    setHotspotState(prev => ({
      ...prev,
      hotspots: prev.hotspots.map(hotspot =>
        hotspot.id === hotspotId
  ...
  const handleToggleAddMode = () => {
    setHotspotState(prev => ({
      ...prev,
      isAddingHotspot: !prev.isAddingHotspot,
    }));
  };
    ...
    <div className="layout-container">
      ...
      <div className="main-container">
        <FlexLayout
          ...
          selectedHotspotId={hotspotState.selectedHotspotId}
          isAddingHotspot={hotspotState.isAddingHotspot}
          onHotspotCreate={handleHotspotCreate}
          onHotspotSelect={handleHotspotSelect}
          onHotspotUpdate={handleHotspotUpdate}
          onHotspotDelete={handleHotspotDelete}
          onHotspotToggleVisibility={handleHotspotToggleVisibility}
